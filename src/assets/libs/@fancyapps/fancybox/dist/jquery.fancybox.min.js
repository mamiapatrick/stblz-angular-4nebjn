...
! function(t, e, n, o) {
    ...
    if (t.console = t.console || { info: function(t) {} }, n) {
        ...
        n.extend(b.prototype, {
                ...
                focus: function(t, o) {
                    var i, a, s = this,
                        r = ["a[routerLink]", "area[routerLink]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden])", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"])'].join(",");
